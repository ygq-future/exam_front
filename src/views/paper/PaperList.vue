  ...
  <div class="content" v-loading="loading">
    <div class="oper">
      ...
      <el-select clearable v-model="query.subjectId" placeholder="学科查询" @change="search">
        <el-option v-for="(item, idx) in subjectList" :key="idx" :label="item.name" :value="item.id" />
      </el-select>
    ...
    <el-card class="card">
      <el-table
        ...
        default-expand-all
      >
        <el-table-column align="center" prop="name" label="试卷名称" width="230" />
        ...
        <el-table-column align="center" fixed="right" label="操作" width="200">
          <template slot-scope="scope">
            <template v-if="scope.row.id > 0">
              ...
              <el-button style="margin-right: 10px" type="text" @click="$router.push(`/paper-edit?id=${scope.row.id}`)"> 编辑</el-button>
              <el-popconfirm
    ...
    <el-dialog custom-class="push" title="推送试卷" center :visible.sync="pushDialog" width="400px" :close-on-click-modal="false">
      <div class="pushItem">
