        ...
        <el-container>
            ...
            <el-header height="60">
                <el-row :gutter="20">
                    <el-col :span="5">
                        <!--两个选项框 -->
                        <el-select v-model="query.majorId" placeholder="请选择专业" filterable clearable
                            @change="majorChange">
                    ...
                    <!-- 班级选项卡 -->
                    <el-col :span="5">
                        <el-select v-model="query.clazzId" placeholder="请选择班级" filterable clearable
                            @change="getStudent">
                            <el-option v-for="item in children" :key="item.id" :label="item.name" :value="item.id">
                            </el-option>
                        </el-select>
                    </el-col>

                    <el-col :span="8">
                        <el-input placeholder="请输入关键字" v-model="query.keyword" @input="getStudent">
            ...
            <el-main height="100%">
                <el-table :data="studentList" style="width: 100%" border stripe max-height="580">
                    ...
                    <el-table-column prop="majorName" label="专业" align="center" width="180">
                    </el-table-column>
            ...
            <el-footer height="50">
                <el-pagination style="text-align: center;" background layout="total, sizes, prev, pager, next, jumper"
                    :total="page.total" :current-page="page.current" :page-size="page.size" @prev-click="getStudent"
                    @next-click="getStudent" @current-change="pageNumberChange" @size-change="changeSize">
                </el-pagination>
            </el-footer>
